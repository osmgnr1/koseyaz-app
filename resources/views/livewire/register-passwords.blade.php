<div class="flex-col mb-4">
    ...
    <div class="relative flex-1 col-span-4" x-data="{ show: true }">
        ...
        <input class="w-full rounded-md py-2 px-4 text-sm border border-blue-500 focus:outline-none focus:border-blue-500 focus:ring-blue-500 focus:ring-1" placeholder="Şifrenizi giriniz" required
                id="password"
