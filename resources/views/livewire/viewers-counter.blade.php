...
<div class="flex space-x-1 justify-end items-center">
    ...
    <svg width="20px" height="20px" viewBox="0 -0.5 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" class="si-glyph si-glyph-view" fill="#000000">
    ...
    <span class="text-slate-600 font-extrabold text-center text-base">{{ $viewers }}</span>
</div>
</div>
