...
@section('content')
    ...
    <div class="w-3/4 justify-self-center px-10 border-2 border-blue-500 rounded-xl">
        <h2 class="my-4 text-4xl tracking-tight font-bold text-center">Giriş Yap</h2>

        <form action="{{ route('auth.store') }}" class="" method="POST">
            @csrf
            ...
            <div class="flex-col mb-4 text-center">
                <button type="submit" class="font-semibold w-1/2 border border-blue-400 p-2 px-6 rounded-2xl bg-sky-300 text-md hover:bg-sky-500">Giriş Yap</button>
            </div>
